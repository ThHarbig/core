...
public class ValueContainedInMIOSubset extends AbstractDataProcessor<Object, Boolean> 
implements OptionPanelProvider, StorageNodeStorable, ProbeListListener
{
	...
	public PluginInfo register() throws PluginManagerException {
		PluginInfo pli = new PluginInfo(
				(Class)this.getClass(),
				"PAS.dynamicPL.source.ValueMIOPartContained",
				new String[0],
				MC,
				new HashMap<String, Object>(),
				"Florian Battke",
				"battke@informatik.uni-tuebingen.de",
				"Value contained in MIO Group subset",
				"Value contained in meta-information group subset"
		);
		return pli;
	}
