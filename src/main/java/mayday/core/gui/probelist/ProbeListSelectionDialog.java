...
public class ProbeListSelectionDialog extends MaydayDialog implements WindowListener{
	...
	private ProbeListSelectionPanel selPanel;
	
	private ArrayList<AbstractAction> additionalOKActions = new ArrayList<AbstractAction>();
	
	public ProbeListSelectionDialog(ProbeListManager plm) {
		setModal(true);
		selPanel = new ProbeListSelectionPanel(plm);
		init();
	}
	
	public ProbeListSelectionDialog(Collection<ProbeListManager> plms) {
		setModal(true);
		selPanel = new ProbeListSelectionPanel(plms);
		init();
	}
	...
	private void init() {
		...
		dialogDescription.setText("Please select one or more probe lists.");
		...
		this.setTitle("Probe List Selection");
