...
public class SetProbeDisplayNames extends AbstractPlugin implements DatasetPlugin {
	...
	public PluginInfo register() throws PluginManagerException {
		PluginInfo pli = new PluginInfo(
				(Class)this.getClass(),
				"PAS.core.DatasetSetProbeDisplayNames",
				new String[0],
		...
		pli.setMenuName("Set Probe Display Names...");
		return pli;
	}
	...
	public List<DataSet> run(List<DataSet> datasets) {
        ...
        if ( l_mioSelection != null ) {
        	...
        	if (l_mioSelection.size() >0) {
        		l_selectedValue.setProbeDisplayNames( l_mioSelection.get( 0 ) );
        	}
        }
