...
public class Export_3_0 extends AbstractPlugin implements DatasetFileExportPlugin {
	
	@SuppressWarnings("unchecked")
	public PluginInfo register() throws PluginManagerException {
		PluginInfo pli = new PluginInfo(
				(Class)this.getClass(),
				"PAS.zippedsnapshot.write.3_0",
				new String[0],
				...
				"Zipped Snapshot Export (Mayday 2.10)"
		);
		...
		pli.getProperties().put(GUDEConstants.TYPE_DESCRIPTION,"Old Snapshot Format (until Mayday 2.10)");		
		return pli;
	}
		...
		AbstractTask at = new AbstractTask("Writing Snapshot") {
			...
			protected void doWork() throws Exception {
				...
				for (DataSet ds : datasets) {
					...
					Snapshot snap = new Snapshot_v3_0();
					snap.setDataSet(ds);
