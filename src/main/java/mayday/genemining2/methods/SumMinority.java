 ...
 *
 */
public class SumMinority extends AbstractImpurityMiningMethod {

	@Override
	public PluginInfo register() throws PluginManagerException {
		PluginInfo pli = new PluginInfo(this.getClass(),
				"PAS.genemining.summinority", new String[0], ScoringPlugin.MC,
				new HashMap<String, Object>(), "G\u00FCnter J\u00E4ger",
				"jaeger@informatik.uni-tuebingen.de",
				"Sum of Minority calculates the sum of misclassified instances \n " +
				"under the assumption of a hyperplane applied to a decision tree",				
				"Sum of Minority");
		return pli;
	}
