...
public class ColumnNameHeader extends AbstractCellBasedColumnHeader {
	...
	public void renderCell(Graphics2D g, int column, AbstractColumnGroupPlugin group) {
		...
		String columnName = data.getColumn(column).getName();
		
		horizontalLabel.setText(columnName);
	...
	public PluginInfo register() throws PluginManagerException {
		return new PluginInfo(
				getClass(),
				"PAS.Heatmap.ColumnHeader.ColumnName",
				null,
				MC_COL,
				null,
				"Florian Battke",
