...
public class MultiBarConfiguration extends BarConfiguration implements ChangeListener {
	...
	public MultiBarConfiguration(HeatmapStructure struct) {
		super(struct, "Expression bars");
