...
import wsi.ra.chart2d.DArray;
import wsi.ra.chart2d.DBorder;
import wsi.ra.chart2d.DComponent;
import wsi.ra.chart2d.DIntDoubleMap;
...
//            Graphics2D g = (Graphics2D) m.getGraphics();
            ...
            else
            {
                ...
                // @Streiche: Mal wieder eine index out of bounds exception, dass ist einfach mist...
